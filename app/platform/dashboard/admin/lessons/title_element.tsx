                ...
                <div className="w-full grid grid-cols-3 gap-4 mt-4 mb-2">
                        ...
                        <AlertDialogContent>
                            ...
                            <AlertDialogTitle>{t('lessons.create_lesson')}</AlertDialogTitle>
                                <div className="flex flex-col gap-4 rtl:text-right w-full">
                                    ...
                                    <div className='flex flex-col'>
                                        {fieldInput(t('lessons.what_heard'), "what_is_heard_from_sheikh", "", "text")}
                                        {createFormSubmitted && createState?.error?.what_is_heard_from_sheikh && <p className="text-red-500 text-sm">{createState.error.what_is_heard_from_sheikh}</p>}
                                    </div>
                                    <div className='flex flex-col'>
                    ...
                    <AlertDialogContent>
                        ...
                        <div className="flex flex-col gap-4 w-full">
                            {fieldInput(t('lessons.lesson_details'), "lesson-day", "", "text")}
