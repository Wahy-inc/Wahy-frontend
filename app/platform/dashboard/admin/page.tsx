        ...
        <div className="flex flex-row justify-between w-full mt-14 lg:mt-15 min-h-[90vh]">
            ...
            >
                <div id='services'>
                    ...
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/admin/home')}}> <icon.House className='inline mr-4'/>{t('home.title')}</h2>
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/admin/analytics')}}> <icon.Users className='inline mr-4'/>{t('analytics.title')}</h2>
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/admin/calender')}}> <icon.Calendar className='inline mr-4'/>{t('calendar.title')}</h2>
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/admin/schedules')}}> <icon.Clock className='inline mr-4'/>{t('schedules.title')}</h2>
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/admin/lessons')}}> <icon.Layers className='inline mr-4'/>{t('lessons.title')}</h2>
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/admin/library')}}> <icon.Book className='inline mr-4'/>{t('library.title')}</h2>
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/admin/students')}}> <icon.Users className='inline mr-4'/>{t('students.title')}</h2>
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/admin/invoices')}}> <icon.DollarSign className='inline mr-4'/>{t('invoices.title')}</h2>
                </div>
                <div id='logout'>
