        ...
        <div className="flex flex-row justify-between w-full mt-14 lg:mt-15 min-h-[90vh]">
            ...
            >
                <div id='services'>
                    ...
                    {isAdmin? <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/analytics')}}> <icon.Users className='inline mr-4'/>Analytics</h2> : null}
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/schedules')}}> <icon.Clock className='inline mr-4'/>Schedules</h2>
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/lessons')}}> <icon.Layers className='inline mr-4'/>Lessons</h2>
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/library')}}> <icon.Book className='inline mr-4'/>Library</h2>
                    {isAdmin? <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/students')}}> <icon.Users className='inline mr-4'/>My Students</h2> : null}
                    {isStudent? <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/profile')}}> <icon.Users className='inline mr-4'/>My Profile</h2> : null}
                    <h2 className="text-xl lg:text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => {setMobileSidebarOpen(false); router.push('/platform/dashboard/invoices')}}> <icon.DollarSign className='inline mr-4'/>Invoices</h2>
                </div>
                <div id='logout'>
                    <h2 className="text-xl lg:text-2xl text-red-500 font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-red-500 hover:text-slate-200 hover:border-l-4 hover:border-slate-200" onClick={() => signout()}> <icon.LogOut className='inline mr-4'/>Logout</h2>
                </div>
            </div>
