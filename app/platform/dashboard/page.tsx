        ...
        <div className="flex flex-row justify-between w-full mt-15 min-h-[90vh]">
            <div id="sidebar" className="flex flex-col justify-between pt-4 pb-20 sticky top-0 overflow-x-hidden bg-slate-900 text-slate-100 lg:w-sm min-h-screen max-h-screen rounded-r-xl mr-4 shadow-[0px_4px_30px_rgba(0,0,0,0.3)] backdrop-blur-sm">
                <div id='services'>
                    ...
                    {isAdmin? <h2 className="text-2xl font-bold p-5 pr-0 cursor-pointer transition duration-300 ease-in-out hover:translate-x-2 hover:bg-slate-500 hover:text-slate-950 hover:border-l-4 hover:border-slate-200" onClick={() => router.push('/platform/dashboard/analytics')}> <icon.Users className='inline mr-4'/>Analytics</h2> : null}
