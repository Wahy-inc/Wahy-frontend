              ...
              <SelectValue />
                  ...
                  <SelectContent>
                    <SelectGroup>
                      ...
                      <SelectItem value='fr'>{t('language_options.french')}</SelectItem>
                      <SelectItem value='de'>{t('language_options.german')}</SelectItem>
                      <SelectItem value='es'>{t('language_options.spanish')}</SelectItem>
